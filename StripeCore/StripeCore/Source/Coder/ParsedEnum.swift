...
extension ParsedEnum {
    ...
    public static func == (lhs: E, rhs: Self) -> Bool {
        lhs == rhs.value
    }
...
extension Set {
    /// Check containment by a known enum value when the set element is ParsedEnum.
    ...
    /// Insert a known enum value when the set element is ParsedEnum.
